...
class ScoreNetTrainerFast:
    def __init__(self, model, classifier, train_loader, valid_loader, test_loader, savepath, args, logger,
        ...
        self.criterion_no_reduce = CrossEntropyLoss(reduction='none')
        # Misc.
        self.logger = logger
    ...
    def on_epoch_end(self, end_epoch):
        ...
        #print("Number of F1 scores:", len(self.f1_scores['class'][-1]))
        #print("Number of class keys:", len(self.test_loader.dataset.class_dict.keys()))
